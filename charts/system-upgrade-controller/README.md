...
![Version: 0.2.4](https://img.shields.io/badge/Version-0.2.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.19.0](https://img.shields.io/badge/AppVersion-v0.19.0-informational?style=flat-square)
...
| job | object | `{"activeDeadlineSeconds":900,"backoffLimit":99,"imagePullPolicy":"Always","kubectlImage":"rancher/kubectl:v1.35.1","privileged":true,"ttlSecondsAfterFinish":900}` | Job configuration for upgrade plans |
...
| job.kubectlImage | string | `"rancher/kubectl:v1.35.1"` | kubectl image for upgrade jobs |
