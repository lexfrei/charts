...
![Version: 0.16.7](https://img.shields.io/badge/Version-0.16.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2026.9.3](https://img.shields.io/badge/AppVersion-2026.9.3-informational?style=flat-square)
...
```bash
cosign verify \
  ghcr.io/lexfrei/charts/cloudflare-tunnel:0.16.7 \
